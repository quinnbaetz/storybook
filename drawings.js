    function crank() {
		ctx.drawImage(imgs["crank"], cCrankX-crankWidth/2, cCrankY-crankHeight+70, crankWidth, crankHeight);
	}
    ...
    function smallGear() {
	  ...
	  if(true){
		  ctx.drawImage(imgs["bGear"], cBGearX-bGearWidth/2, cBGearY-bGearHeight/2, bGearWidth, bGearHeight);
	  }else{
